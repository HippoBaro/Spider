...
//  else
//  {
//    spider::RequestPacket envelope;
//    envelope.set_method(spider::RequestPacket_MethodID_SEND);
//
//    spider::CmdPacket command;
//    command.set_targetuuid(splittedCommands[0]);
//    command.set_name(splittedCommands[1]);
//    if (splittedCommands.size() == 3)
//      command.set_argument(splittedCommands[2]);
//  }
//}
//
